#ifndef MERGE_AND_SHRINK_GREEDY_ORDER_UTILS_H
#define MERGE_AND_SHRINK_GREEDY_ORDER_UTILS_H
...
extern void add_scoring_function_option_to_feature(plugins::Feature &feature);
}
