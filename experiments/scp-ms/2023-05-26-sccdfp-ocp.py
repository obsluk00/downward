...
OLD_REV='cb6cd8738856fc97004f069b5ea4a2d7ee7c0a7c'
REVISION='9fecd461ade4532fc1739fc9e7f432f1f52cdc28'
REVISIONS = [REVISION]
TIME_LIMIT=1800
...
exp.add_fetcher(
    'data/2023-05-26-sccdfp-ocp-old-eval',
    filter_algorithm=[
        '{}-b50k-t900-sccdfp-atomicnolrocp'.format(OLD_REV),
        '{}-b50k-t900-sccdfp-atomiclrocp'.format(OLD_REV),
        '{}-b50k-t900-sccdfp-interleavedocp-rnd-i1-afterlr'.format(OLD_REV),
        '{}-b50k-t900-sccdfp-offlineocp-rnd-i1-afterlr'.format(OLD_REV),
    ],
    merge=True
)
