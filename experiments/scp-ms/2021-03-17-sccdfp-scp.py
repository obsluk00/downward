...
REVISIONS = ['0522936d4d3aec5cacb9e8474a6b809e50045512']
DIV_TIME_LIMIT=200
...
OLD_REVISION='9f5ea993a8f7'
# fetch last data from hg repo
exp.add_fetcher(
    'data/2021-03-16-sccdfp-scp-eval',
    filter_algorithm=[
        '{}-b50k-t900-sccdfp-interleavedscp-rnd-afterlr'.format(OLD_REVISION),
        '{}-b50k-t900-sccdfp-interleavedscp-rnd-i1-afterlr'.format(OLD_REVISION),
        '{}-b50k-t900-sccdfp-offlinescp-rnd-i1-afterlr'.format(OLD_REVISION),
        '{}-b50k-t900-sccdfp-offlinescps-rnd-i1-afterlr'.format(OLD_REVISION),
    ],
    merge=True
)
